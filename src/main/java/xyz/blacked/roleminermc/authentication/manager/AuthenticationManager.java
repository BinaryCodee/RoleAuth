package xyz.blacked.roleminermc.authentication.manager;

import de.mkammerer.argon2.Argon2;
import de.mkammerer.argon2.Argon2Factory;
import net.md_5.bungee.api.connection.ProxiedPlayer;
import org.mindrot.jbcrypt.BCrypt;
import xyz.blacked.roleminermc.authentication.RoleLogin;
import xyz.blacked.roleminermc.authentication.checks.IsCrackedPremiumCheck;
import xyz.blacked.roleminermc.authentication.checks.MojangCheck;
...
public class AuthenticationManager {
    ...
    private String hashPassword(String password) {
        String hashMethod = plugin.getConfiguration().getString("settings.hash-method", "argon2").toLowerCase();
